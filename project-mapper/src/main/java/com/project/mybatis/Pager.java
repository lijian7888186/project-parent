...
public class Pager {
    ...
    private SqlSort[]			sorts;									//多个order by字段

    public SqlSort[] getSorts() {
		return sorts;
	}

	public void setSorts(SqlSort[] sorts) {
		this.sorts = sorts;
	}
	public void setSorts(List<SqlSort> sorts) {
		if (sorts == null || sorts.size() == 0) {
			this.sorts = null;
			return;
		}
		SqlSort[] temp = new SqlSort[sorts.size()];
